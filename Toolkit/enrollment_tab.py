...
class EnrollmentTab(ttk.Frame):
    def __init__(self, parent):
        ...
        self.setup_ui()
        # Make sure the frame expands to fill the tab
    ...
    def extract_features(self, audio_path, n_mfcc=22, use_dmfcc=False, use_ddmfcc=False):
        ...
        try:
            ...
            # Transpose to get time frames as rows and features as columns
    ...
    def process_speaker(self, speaker_folder, num_utterances, n_mfcc, use_dmfcc, use_ddmfcc):
        ...
        # If num_utterances is specified, randomly select that many files
    ...
    def browse_training(self):
        ...
        if folder:
            ...
            # Auto-set number of utterances based on minimum recordings
